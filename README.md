...
- Built-in LLM-Tools (`BuiltinTools.definitions` + `BuiltinTools.createInvoker`) für `ReadFile`, `WriteFile` (mit `append`), `EditFile`, `Glob`, `Grep`, `Shell` (PowerShell/Bash) und `WebSearch`
